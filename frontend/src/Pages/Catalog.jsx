...
export default function Catalog() {
  ...
  const categories = [
    "All", "Computer", "Laptop", "Monitor", "Keyboard", "Mouse",
    "Printer", "Projector", "Networking", "Microcontroller",
    "RaspberryPi", "Arduino", "Cable", "Adapter", "StorageDevice",
    "Document", "SoftwareLicense", "Other",
  ];
      ...
      <div className="p-5 flex flex-col flex-1">
        <div className="flex justify-between items-start mb-2">
          <div className="flex-1 pr-2">
            ...
            <h3 className="font-bold text-gray-900 text-lg leading-tight line-clamp-2" title={tool.name}>{tool.name}</h3>
          </div>

          <div className={`shrink-0 flex items-center gap-1 text-[11px] font-bold px-2 py-1 rounded-full uppercase
